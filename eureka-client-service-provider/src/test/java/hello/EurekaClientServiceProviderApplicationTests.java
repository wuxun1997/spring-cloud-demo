...
//@SpringBootTest(classes = EurekaClientServiceProviderApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
//@ActiveProfiles("test")
//public class EurekaClientServiceProviderApplicationTests {
//
