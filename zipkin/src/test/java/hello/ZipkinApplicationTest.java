...
//@SpringBootTest(webEnvironment= SpringBootTest.WebEnvironment.RANDOM_PORT, classes = ZipkinApplication.class)
...
//    @Test
//    public void test() {
//        String resp = rest.getForObject("/consumer/available", String.class);
