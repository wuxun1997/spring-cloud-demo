...
//        Thread.sleep(3000);
//
//        ResponseEntity<String> response = this.testRestTemplate.getForEntity("http://localhost:" + this.port + "/service-instances/a-beautiful-client2", String.class);
//
//        then(response.getStatusCode()).isEqualTo(HttpStatus.OK);
//        then(response.getBody()).contains("a-beautiful-client2");
//    }
//
//    @Configuration
